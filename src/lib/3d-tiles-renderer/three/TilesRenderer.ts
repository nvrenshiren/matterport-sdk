...
import { GLTFExtensionLoader } from "./loaders/GLTFExtensionLoader"
import { TilesGroup } from "./TilesGroup"
import { Matrix4, Vector3, Vector2, LoadingManager, EventDispatcher, REVISION } from "three"
import { raycastTraverse, raycastTraverseFirstHit } from "./raycastTraverse"
import { readMagicBytes } from "../utilities/readMagicBytes"
import { TileBoundingVolume } from "./math/TileBoundingVolume"
import { ExtendedFrustum } from "./math/ExtendedFrustum"
...
export class TilesRenderer extends TilesRendererBase {
  ...
  _upRotationMatrix: Matrix4
  _loadingTiles: boolean
  ...
  onLoadTileSet: Function
  onLoadModel: Function
  onDisposeModel: Function
  onTileVisibilityChange: Function
}
...
;[
  ...
  Object.defineProperty(TilesRenderer.prototype, methodName, {
    get() {
