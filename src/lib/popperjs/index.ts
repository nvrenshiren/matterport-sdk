...
function getClippingParents(element) {
  ...
  return clippingParents.filter(function (clippingParent) {
    return (
      ...
      (canEscapeClipping ? getComputedStyle(clippingParent).position !== "static" : true)
    )
  })
}
...
function preventOverflow(_ref) {
  ...
  if (checkAltAxis) {
    ...
    var _preventedOffset =
      tether && isOriginSide ? withinMaxClamp(_tetherMin, _offset, _tetherMax) : within(tether ? _tetherMin : _min, _offset, tether ? _tetherMax : _max)
